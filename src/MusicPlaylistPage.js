...
class MusicPlaylistPage extends React.Component {
  ...
  //   This is hardcoded data -1
  componentDidUpdate(prevProps, prevState) {
    // Multiple pieces of nesting -1
  ...
  render() {
    ...
    const cards = data.map((item) => {
      return (
        ...
        // In the java course we mention of grouping variables to avoid sending more than 3 per function.
        // Same principles apply in any computer language
        <Card
          key={item.id}
          title={item.title}
          artist={item.artist}
    ...
    return (
      <selection id="root">
        ...
        <main>
          ...
          <div class="Play-Menu">
            <img
              className="Big-Green-Play-Button"
              src={require("./Images/Icons/Big-Green-Play-Button.png")}
              alt="Play-Button"
            />
          </div>
          <div>{cards}</div>
          ...
          <article className="Mp3Player">
            ...
            <div className="Mp3Player-Content-Right">
              ...
              <div>
                ...
                {this.state.player === "playing" && (
                  <button
                    className="Mp3Player-Item Pause"
